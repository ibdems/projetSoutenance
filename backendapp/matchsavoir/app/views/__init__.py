...
from .formations_view import PrerequisDetailView, PrerequisListView, CriteresDetailView, CriteresListView, ObjectifsDetailView, ObjectifsListView, AnneeDetailView, FormationView, AnneeListView,FormationDetailView
from .sessions_view import SessionDetailView, SessionListView, CalendrierListView, CalendrierDetailView, DemandeInscription, AcceptDemande,RefuserDemande, DemandeInscriptionDetail
