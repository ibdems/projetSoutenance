...
import { Form, Row, Col, FormGroup, Card,CardBody } from 'reactstrap';
...
export default function AjoutFormation() {
  ...
  return (
    <div>
      <Form className={`mt-3 bg-white ${window.innerWidth <= 576 ? 'ms-1 p-2' : 'ms-4 p-5'}` } onSubmit={handleSubmit}>
        <Row>
          <Col xl={7}>
            <FormGroup>
        ...
        <Row className='mt-3'>
          <Col></Col>
          <Col><MyButton onClick={() => { }} text='Enregistrer' bgColor={'green'} /></Col>
          <Col><MyButton onClick={() => { }} text='Annuler' bgColor={'gray'} /></Col>
          <Col></Col>
        </Row>
      </Form>
    </div>
